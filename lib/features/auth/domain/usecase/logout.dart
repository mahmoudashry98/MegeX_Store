...
class LogoutUseCase extends BaseUseCase<LogoutModel, LogoutParameters>{
  final AuthBaseRepository authBaseRepository;

  LogoutUseCase({required this.authBaseRepository});

  @override
  Future<Either<PrimaryServerException, LogoutModel>> call(LogoutParameters parameters) async {
